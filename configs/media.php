...
return [
    'default_replacements' => [
        ...
        'icon' => env('MEDIA_DEFAULT_REPLACEMENT_ICON', 'img/icons/logo-icon-white.svg'),
        'icon_single_color' => env('MEDIA_DEFAULT_REPLACEMENT_ICON_SINGLE_COLOR', 'img/icons/logo-icon-white.svg'),
