...
<template>
  ...
  <Loading
    ...
    width="100px"
    height="100px"
    v-model:active="checkLoginLoading"
    :can-cancel="false"
    :is-full-page="true"
        ...
        <div class="card">
          <div class="card-info flex-row justify-content-center">
            <a class="item right active">
              <div class="text d-flex">
                <span class="title"
                  >ورود <small class="fs-16 fw-700 px-1"> | </small> عضویت</span
                >
              </div>
            </a>
          </div>
          ...
          <div class="content align-items-center">
            ...
            <div v-if="!isLoading">
              <PriorityOneCard
                :clientUrl="clientUrl"
                v-if="currentCard === 'priority_one_card'"
                :priority1="authSetting.loginFields.priority1"
                :authTitle="authSetting.authTitle"
                @goToCard="setCurrentCard"
              >
              </PriorityOneCard>
              <PriorityTwoCard
                v-if="currentCard === 'priority_two_card'"
                :clientUrl="clientUrl"
                :authTitle="authSetting.authTitle"
                :priority2="authSetting.loginFields.priority2"
                @goToCard="setCurrentCard"
              >
              </PriorityTwoCard>
              <OtpCard
                v-if="currentCard === 'otpCard'"
                :clientUrl="clientUrl"
                :prevCard="prevCard"
                @goToCard="setCurrentCard"
                :help="otpHelp"
