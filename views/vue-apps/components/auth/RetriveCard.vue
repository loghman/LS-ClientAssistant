...
<template>
    <Form autocomplete="off" @submit="(values) => handleSubmitForm(values)" @invalid-submit="onInvalidSubmit"
        ...
        <div>
            ...
            <div class="fields-frame">
                <div class="auth-inputs gap-3">
                    ...
                    <InputGroup type="password" :showforgetButton="false" fieldName="password" labelText="رمز عبور"
                        labelClass="right-30"></InputGroup>

                    <InputGroup type="password" :showforgetButton="false" fieldName="repeat_password"
                        labelText="تکرار رمز عبور" labelClass="right-30"></InputGroup>
