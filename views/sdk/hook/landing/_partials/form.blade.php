<div class="container-fluid ls-client-hook-section-footer" id="ls-client-hook-download">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-7 col-10">
                <div class="ls-client-hook-section-form">
                    ...
                    <span class="ls-client-hook-t-title-sm ls-client-hook-text-center">پس از اسال فرم، <span class="ls-client-hook-text-primary">چیت شیت</span> به ایمیل شما
                        <br>
                        ارسال خواهد شد</span>
                    {!! $shapeFooterLine !!}
                </div>
