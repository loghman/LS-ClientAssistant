...
<div class="{{ $subClass }}card">
    <div class="{{ $subClass }}header">
        ...
        <span class="{{ $subClass }}title">کتاب اصل گرایی</span>
    </div>
    ...
    <h3 class="{{ $subClass }}hr-text">برای دریافت <span class="{{ $subClass }}opacity">چیت شیت پایتون</span> فرم زیر رو پر کن</h3>
    <div class="{{ $subClass }}grid {{ $subClass }}items-4">
        <input type="text" name="" class="{{ $subClass }}input" placeholder="نام و نام خانوادگی را وارد کنید ...">
        <input type="text" name="" class="{{ $subClass }}input" placeholder="شماره موبایل را وارد کنید ...">
        <input type="text" name="" class="{{ $subClass }}input" placeholder="ایمیل را وارد کنید ...">
        <button class="{{ $subClass }}btn">ارسال و دریافت</button>
    </div>
</div>