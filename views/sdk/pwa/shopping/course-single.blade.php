...
<body>
    <div class="base-container">
        ...
        <div class="base-content">
            <div class="bghead" style="--bg: url(<?= $thumb ?>)">
            ...
            <div class="wpad tpad bpad">
                @if(!$enrollment)
                    <div class="info bpad">
                        ...
                        <div style="margin-left: 10px">
                            <span
                                class="title"><?= to_persian_num($course['items_count'] - count($course['chapters'])) ?></span>
                ...
                @if(!$enrollment)
                    ...
                    $len = strlen($desc);
                                                    ...
                                                    <div class="title-row bpad-half tpad">
                    ...
                    $chapterCount = count($course['chapters']); ?>
                                                    <div class="accordions type-white">
                                                        @foreach ($course['chapters'] as $ii => $ch)
                                                                                                                <?php        if ($ch['type_en'] != 'chapter' || !$ch['is_published']) {
                                                                continue;
                                                            } ?>

                                                                                                                <div class="accordion <?= 0 == $i++ ? '' : '' ?> <?= $chapterCount == 1 ? 'expanded' : '' ?>">
                                                                                                                    <div class="header">
                                                                                                                        <span class="title singline">
                                                                                                                            @if ($chapterCount == 1)
                                                                                                                                <span class='bold'><?= $ch['title'] ?></span>
                                                                                                                            @else
                                                                                                                                <span class='bold'>فصل <?= to_persian_num($i) ?> : </span>
                                                                                                                                <?= to_persian_num($ch['title']) ?>
                                                                                                                            @endif
                                                                                                                        </span>
                                                                                                                        <span class="stat me-auto"><?= to_persian_num(count($ch['items'] ?? '0')) ?> جلسه</span>
                                                                                                                    </div>
                                                                                                                    <div class="content">
                                                                                                                        <ul class="list wpad-half bpad-half">
                                                                                                                            <?php        $si = 1; ?>
                                                                                                                            @foreach ($ch['items'] as $item)
                                                                                                                                <li>
                                                                                                                                    <span class="title"><?= to_persian_num($item['title']) ?></span>
                                                                                                                                    <span
                ...
                @else
                    <div class="card-simple">
                        <i class="icon far fa-check-circle mx-auto"></i>
                        <p class="title text-center">شما قبلا در این دوره ثبت نام کرده اید.</p>
                        <a class="btn mx-auto"
                            href="<?=site_url("pwa/course/{$enrollment['entity_id']}/chapters?e={$enrollment['id']}")?>">
                            مشاهده دوره
