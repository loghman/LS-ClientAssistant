...
<body>
    ...
    <div class="base-content">
            ...
            <div class="bgcaption">
                <span class="content">
                    <span class="text">
                        ...
                        <span class="content">
                            <small class="subtitle"><?= $course['meta']['slogan'] ?? '' ?></small>
                        </span>
        ...
        <div class="content">
            <div class="info">
                <div class="full ms-auto teacher">
                    <img src="<?= $course['mainTeacherFaculty']['avatar_url'] ?? '' ?>"
                        alt="<?= $course['mainTeacherFaculty']['full_name'] ?>" class="avatar">
                    <div class="text">
                        <small class="subtitle" style="font-size: 8px;margin-bottom:-7px">مدرس</small>
                        <span class="title"
                            style="font-size: 12px"><?= $course['mainTeacherFaculty']['full_name'] ?></span>
                    </div>
                </div>
                <div>
