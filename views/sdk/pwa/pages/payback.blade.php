    ...
    <div class="base-content" style="margin: 0 auto">
        @if($status)
            ...
            <div class="content" style="margin-top: 30px;text-align: center;font-size: 20px">
                ...
                <div style="padding: 0 20px">از اعتماد شما سپاسگزاریم<br>می توانید از بخش دوره های من شروع به مشاهده محتوا
                    کنید</div>
                <div><a href="<?=site_url('pwa/my-courses')?>" class="btn" style="min-width: 70%; margin-top: 30px;">مشاهده
                        دوره های من</a></div>
            </div>
        @else
            <div class="card-status bghead m-0 shadow-inset pt pb">
