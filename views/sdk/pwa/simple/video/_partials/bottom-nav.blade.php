<nav class="bottom-nav screen-nav">
    ...
    <a class="bnavi" href="<?=site_url('pwa/simple/product/12/chapters')?>" style="width: 70%;justify-content: start;padding-right:24px">
        <!-- <i class="fa-solid fa-bars"></i> -->
        <!-- این پایین درصد پیشرفت کل دوره هست -->
         <?=circleProgressbar(47,'xs','nav-progress');?>
