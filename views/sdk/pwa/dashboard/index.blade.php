...
<div>
    ...
    <div dir="rtl" class="swiper lastseens wpad">
        ...
        @foreach($enrollments as $e)
            ...
            <a href="<?=site_url("pwa/course-{$product['id']}/screen?e={$e['id']}")?>" class="swiper-slide enroll-slide" style="background: linear-gradient(0deg, var(--primary-50), rgba(0,0,0,0.3)), url(<?=$product['banner_url']['medium']['url']?>);"> 
