<div class="overlay" id="feedback-overlay">
    <div class="overlay-panel" data-pid="{{ $item->product_id }}" data-iid="{{ $item->id }}">
        ...
        <p style="margin-bottom:30px;color:#333">پس از ثبت نظر به جلسه بعد منتقل می شوید.</p>
        ...
        <div class="loader" style="margin-top: 20px;display: none;"></div>
        <div class="goto-next" style="text-align: center;margin-top:10px;display: none;">در حال ثبت و رفتن به جلسه بعدی ...</div>
    </div>
</div>
